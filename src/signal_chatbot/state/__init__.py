...
log, disclaimers, flags, profiles, final words); ``__main__`` wires the specific
sub-store into each consumer.
"""
...
from signal_chatbot.state.finalwords import FinalWords
from signal_chatbot.state.flags import FlagRegistry, FlagView
